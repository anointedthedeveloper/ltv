...
export default function LivePage() {
  ...
  const categories = ['All', 'Kids', 'News', 'Music', 'Religious', 'Sports', 'Entertainment', 'Movies', 'Nigerian'] as const;
      ...
      <header className="sticky top-0 z-50 bg-black/80 backdrop-blur-xl border-b border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-8 items-center">
            ...
            <Link href="/live" className="text-white font-semibold hover:text-red-500 transition-colors">
              All Channels
            </Link>
